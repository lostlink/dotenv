<nav role="navigation" aria-label="Pagination Navigation"
    ...
    <div class="items-center justify-between w-full sm:flex-1 sm:flex">
        @if ($recordCount === 'full')
            <div>
                <p
                    class="mr-2 leading-5 text-center text-gray-700 text-md dark:text-gray-300 sm:text-right">
        ...
        @elseif($recordCount === 'short')
            <div>
                <p
                    class="mr-2 leading-5 text-center text-gray-700 text-md dark:text-gray-300">
                    ...
                    @if (is_array($element))
                        ...
                        @foreach ($element as $page => $url)
                            @if ($paginator->currentPage() > 3 && $page === 2)
                                <div
                                    class="mx-1 mt-1 text-gray-800 dark:text-gray-300">
                            ...
                            @if ($paginator->currentPage() < $paginator->lastPage() - 2 && $page === $paginator->lastPage() - 1)
                                <div
                                    class="mx-1 mt-1 text-gray-600 dark:text-gray-300">
                                    <span>.</span>
                                    <span>.</span>
                                    <span>.</span>
                                </div>
