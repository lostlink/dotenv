@if ($queues && $showExporting)
    ...
    @if ($batchExporting && !$batchFinished)
        <div wire:poll="updateExportProgress"
            ...
            <div>{{ trans('livewire-powergrid::datatable.export.exporting') }}
            </div>
        </div>
    @endif
        ...
        <div class="my-3">
            <p>
                <button class="btn btn-primary" type="button"
                    ...
                    data-bs-target="#collapseCompleted" aria-expanded="false"
                ...
                <div class="card card-body">
                    @foreach ($exportedFiles as $file)
                        <div class="d-flex w-full p-2" style="cursor:pointer">
                            <x-livewire-powergrid::icons.download style="width: 1.5rem;
                                           margin-right: 6px;
                                           color: #2d3034;" />
                            <a
