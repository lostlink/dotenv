            ...
            <div class="@if ($inline) flex flex-col @else  flex flex-row justify-between @endif">
                <div class="@if (!$inline) pl-0 pt-1 pr-3 @endif">
                    <input data-id="{{ data_get($number, 'field') }}"
                        ...
                        @if ($inline) style="min-width: 100px; max-width: 130px !important; {{ data_get($column, 'headerStyle') }}" @endif type="text"
