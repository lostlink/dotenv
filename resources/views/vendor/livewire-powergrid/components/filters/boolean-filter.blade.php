...
<div>
    @if (filled($booleanFilter))
        <div wire:ignore
            ...
            <div class="relative">
                <select
                    id="input_boolean_filter_{{ data_get($booleanFilter, 'field') }}"
                    ...
                    <option value="all">
                        {{ trans('livewire-powergrid::datatable.boolean_filter.all') }}
                    </option>
                    <option value="true">
                        {{ data_get($booleanFilter, 'true_label') }}</option>
                    <option value="false">
                        {{ data_get($booleanFilter, 'false_label') }}
                    </option>
                </select>
