            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Please provide your Private Key or generate a new one in order to encrypt/decrypt the Variables.
                    </p>
                </div>
                <div x-data="{ isShowing: false }"
                    ...
                    <form class="space-y-6" wire:submit.prevent="submit" method="POST">
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea wire:model="privateKey" id="privateKey" name="privateKey" rows="3"
                        ...
                        >
                            <div>
                                <x-heroicon-o-exclamation class="h-12 w-12 text-red-400"/>
                            </div>
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-gray-500 flex">
                                    It won't be shown again and can't be recovered!
                                </p>
                            </div>
                        </div>
