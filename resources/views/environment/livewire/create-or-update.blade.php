        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Environment Details</h3>
                    <p class="mt-1 text-sm text-gray-500">
                        Environment Details for this Target.
                    </p>
                </div>
                    ...
                    <form class="space-y-6" wire:submit.prevent="submit" method="POST">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input type="text" wire:model="name" name="name" id="name"
                                       ...
                                       placeholder="Production, Staging, Develop, Local, etc">
                            </div>
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                Brief notes of your target if needed.
                            </p>
                        </div>
