                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @foreach ($project->targets as $target)
                                            <a
                                                href="{{ route('project.target.show', ['project' => $project->slug, 'target' => $target->slug]) }}">
                                                <div
                                                    class="text-sm text-gray-500">
                                                    {{ $target->name }}
                                                </div>
                                    ...
                                    <td
                                        ...
                                        <a onclick='Livewire.emit("openModal", "project.update", @json(['project'=> $project->id]))'
                                        ...
                                        <a onclick='Livewire.emit("openModal", "project.delete", @json(['project'=> $project->id]))'
