    ...
    <div class="py-12">
        ...
        <ul role="list"
                    ...
                    <div>
                        <div class="-mt-px flex divide-x divide-gray-200">
                            <div class="w-0 flex-1 flex">
                                <a onclick='Livewire.emit("openModal", "target.delete", @json(['
                                    target'=> $target->id]))'
                            ...
                            <div class="-ml-px w-0 flex-1 flex">
                                <a onclick='Livewire.emit("openModal", "target.update", @json(['
                                    target'=> $target->id]))'
            ...
            <li
                ...
                <button type="button"
                    onclick='Livewire.emit("openModal", "target.create", @json(['
                    project'=> $project->id]))'
