    ...
    <div class="py-12" x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'target' }">
        ...
        <div x-show="tab === 'project'" class="sm:flex" x-cloak>
            <div class="mb-4 flex-shrink-0 sm:mb-0 sm:mr-4">
                <livewire:screenshot.show :model="$target->project" class="h-32 w-full sm:w-32 border border-gray-300 bg-white text-gray-300"/>
            </div>
            <div>
        ...
        <div x-show="tab === 'target'" class="sm:flex" x-cloak>
            <div class="mb-4 flex-shrink-0 sm:mb-0 sm:mr-4">
                <livewire:screenshot.show :model="$target" class="h-32 w-full sm:w-32 border border-gray-300 bg-white text-gray-300"/>
            </div>
            <div>
                <h4 class="text-lg font-bold">
        ...
        @foreach($target->environments as $environment)
            <div x-show="tab === '{{ $environment->routeKey }}'" class="sm:flex" x-cloak>
                <div class="mb-4 flex-shrink-0 sm:mb-0 sm:mr-4">
                    <livewire:screenshot.show :model="$environment" class="h-32 w-full sm:w-32 border border-gray-300 bg-white text-gray-300"/>
                </div>
                <div>
                    <h4 class="text-lg font-bold">
