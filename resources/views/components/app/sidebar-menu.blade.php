<div>
    ...
    <div x-show="mobileMenuOpen" class="fixed inset-0 flex z-40 md:hidden"
        ...
        <div x-show="mobileMenuOpen"
            ...
            class="fixed inset-0 bg-gray-600 bg-opacity-75" @click="open = false"
        ...
        <div x-show="mobileMenuOpen"
            ...
            <div class="flex-shrink-0 flex items-center px-4">
                <x-logo-with-text class="h-8 w-auto" color="#d4d4d4" />
            </div>

            <div class="mt-5 flex-1 h-0 overflow-y-auto">
                <nav class="px-2 space-y-1">
                    <p
                        class="group flex items-center px-2 py-2 text-sm font-medium rounded-md  text-white">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center">
                            <span
                                class="px-3 bg-indigo-700 text-lg font-medium text-white">
                                Main
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-6">
                            <button type="button"
                                onclick='Livewire.emit("openModal", "project.create")'
