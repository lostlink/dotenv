        ...
        <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6"
            ...
            <div class="flex items-center flex-1">
                <div class="flex items-center justify-between w-full md:w-auto">
                    <a href="{{ route('home') }}">
                        <span
                            class="sr-only">{{ config('app.name', 'Laravel') }}</span>
                    ...
                    <div class="-mr-2 flex items-center md:hidden">
                        <button @click="menuOpen = ! menuOpen" type="button"
                            ...
                            <span
                                class="sr-only">{{ __('Open main menu') }}</span>
            ...
            <div class="px-5 pt-4 flex items-center justify-between">
                ...
                <div class="-mr-2">
                    <button @click="menuOpen = ! menuOpen" type="button"
                        ...
                        <span
                            class="sr-only">{{ __('Close menu') }}</span>
            ...
            <div class="pt-5 pb-6">
                ...
                <div class="mt-6 px-5">
                    <p class="text-center text-base font-medium text-gray-500">
                        ...
                        <a href="{{ route('login') }}"
                            class="text-gray-900 hover:underline">{{ __('Log in') }}</a>
                    </p>
                </div>
            </div>
        </div>
