(window.Components = {}),
            ...
            init() {
                let e = (t) => {
                    document.body.contains(this.$el)
                        ? t.target instanceof Element && !this.$el.contains(t.target) && window.dispatchEvent(new CustomEvent("close-popover-group", { detail: this.$el }))
                ...
                "ArrowLeft" === e.detail.key
                    ...
                    : "ArrowRight" === e.detail.key
                        ...
                        : "Home" === e.detail.key || "PageUp" === e.detail.key
                            ...
                            : ("End" !== e.detail.key && "PageDown" !== e.detail.key) || this.onTabClick({ detail: t[t.length - 1] });
            },
        };
    }),
    (window.Components.tab = function (e = 0) {
        return {
            ...
            onKeydown(e) {
                ["ArrowLeft", "ArrowRight", "Home", "PageUp", "End", "PageDown"].includes(e.key) && e.preventDefault(), window.dispatchEvent(new CustomEvent("tab-keydown", { detail: { tab: this.$el, key: e.key } }));
            },
            onTabSelect(e) {
